...
<!-- Image should show a comparison of how different models (ML, Vector, Hybrid) perform on different genre types, highlighting which approach works best for which genres -->
